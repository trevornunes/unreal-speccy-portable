...
void eRom::Init()
{
	...
	LoadRom(ROM_128, xIo::ResourcePath("app/native/res/rom/sos128.rom"));
	LoadRom(ROM_SOS, xIo::ResourcePath("app/native/res/rom/sos48.rom"));
	LoadRom(ROM_SYS, xIo::ResourcePath("app/native/res/rom/service.rom"));
	LoadRom(ROM_DOS, xIo::ResourcePath("app/native/res/rom/dos513f.rom"));
#endif//USE_EMBEDDED_RESOURCES
}
//=============================================================================
//	eRom::Reset
